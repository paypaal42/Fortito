...
/*   Updated: 2017/03/21 16:54:46 by pringsta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "j05-v1-final/ex00/ft_putstr.c"
#include "j05-v1-final/ex01/ft_putnbr.c"
#include "j05-v1-final/ex02/ft_atoi.c"
#include "j05-v1-final/ex03/ft_strcpy.c"
#include "j05-v1-final/ex04/ft_strncpy.c"
#include "j05-v1-final/ex05/ft_strstr.c"
#include "j05-v1-final/ex06/ft_strcmp.c"
#include "j05-v1-final/ex07/ft_strncmp.c"
#include "j05-v1-final/ex08/ft_strupcase.c"
#include "j05-v1-final/ex09/ft_strlowcase.c"
#include "j05-v1-final/ex10/ft_strcapitalize.c"

#include "j05-v1-final/ex11/ft_str_is_alpha.c"
#include "j05-v1-final/ex12/ft_str_is_numeric.c"
#include "j05-v1-final/ex13/ft_str_is_lowercase.c"
#include "j05-v1-final/ex14/ft_str_is_uppercase.c"
#include "j05-v1-final/ex15/ft_str_is_printable.c"
#include "j05-v1-final/ex16/ft_strcat.c"
#include "j05-v1-final/ex17/ft_strncat.c"
#include "j05-v1-final/ex18/ft_strlcat.c"
#include "j05-v1-final/ex19/ft_strlcpy.c"
...
int		main(void)
{
	...
	printf("\n001a 01 a ...a.. ???a //a 000a 99a ::a :a @@@a AAAa [[[a ZZZa zza {{{a  123456789 abcdefgijklmnopqrstuvwxyz .........abcdefg 123qwe     01234$$$\n%s\n", ft_strcapitalize(str_long1));
	printf("\n_________________\nEX11 :\n");
	...
	printf("\n_________________\nEX18 :\n");	
	char paal123[50] = "abcdef123";
	printf(".h : %lu\n", strlcat(paal123, " hello", 50));
	printf(".h : %lu\n", strlcat(paal123, " hello", 40));	
	printf(".h : %lu\n", strlcat(paal123, " hello", 30));	
	printf("ft : %d\n", ft_strlcat(paal123, " hello", 50));
	printf("ft : %d\n", ft_strlcat(paal123, " hello", 40));	
	printf("ft : %d\n", ft_strlcat(paal123, " hello", 30));
	
	printf("\n_________________\nEX18 :\n");	
	char paal1123[50] = "abcdef123";
	printf(".h : %lu\n", strlcpy(paal1123, " hello", 50));
	printf(".h : %lu\n", strlcpy(paal1123, " hello", 40));	
